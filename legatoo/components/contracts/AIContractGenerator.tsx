      ...
      <div className="space-y-4">
        <div>
          ...
          <textarea
            ...
            className="w-full h-48 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:text-white"
          />
        </div>
            ...
            {generateMutation.isPending ? (
              <div className="flex items-center justify-center h-full min-h-[600px]">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">{t("contracts.generate.generatingContract")}</p>
                </div>
              </div>
            ) : generatedContent ? (
              <ContractEditor
