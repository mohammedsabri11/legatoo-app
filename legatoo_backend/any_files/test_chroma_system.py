"""
اختبار النظام الجديد مع Chroma embeddings
"""
...
async def test_with_chroma():
    """اختبار النظام مع Chroma"""
    
    print("🚀 اختبار النظام الجديد مع Chroma embeddings...")
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            ...
            print("🔄 بدء رفع الوثيقة مع Chroma...")
